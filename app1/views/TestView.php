			...
			<div class="span2">
			 ...
			 <ul class="nav nav-sidebar">
                        ...
                        <ul id="one" class="nav nav-list collapse menu-second">
                            <li><a href="../app1/index.php" onclick="" id="one"><i class="fa fa-users"></i>全部展示 </a></li>
                        </ul>
                    ...
                    <h1 class="page-header"><i class="fa fa-cog fa-spin"></i>&nbsp;&nbsp;&nbsp;homework<small>&nbsp;&nbsp;&nbsp;</small></h1>
                        ...
                        <!-- 载入左侧菜单指向的jsp（或html等）页面内容 -->
					      <div class="page">
								<span>上一页</span>
								<a href="#">&laquo;</a></li>
								<a href="views/view1.php">1</a></li>
								<a href="views/view2.php">2</a></li>
								<a href="views/view3.php">3</a></li>
								<a href="#">&raquo;</a></li>
								</span>下一页</span>
						  </div>
                          <div id="content">   
									...
									//    ini_set("max_execution_time", '0');a
										...
										{
											echo "<tr>";
											print_r("<td align=center>{$data[$i]['SenderIP']}</td>");
											print_r("<td align=center>{$data[$i]['TargetIP']}</td>");
											echo "</tr>";
											$i++;
										}
										echo "</table>";
